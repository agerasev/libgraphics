...
static void setTranslation(GContext *context, float x, float y)
{
	context->translation[0] = x;
	context->translation[1] = y;
}

static void setModelview(GContext *context, float a00, float a01, float a10, float a11)
{
...
static void setProjection(GContext *context, float a00, float a01, float a10, float a11)
{
...
void gResize(GContext *context, int width, int height)
{
	context->width = width;
	...
	setProjection(context,2.0f/width,0,0,2.0f/height);
...
void gTransform(GContext *context, const float matrix[4])
{
	setModelview(context, matrix[0],matrix[1],matrix[2],matrix[3]);
}
...
void gSetColorInt(GContext *context, unsigned color)
{
...
void gSetColor(GContext *context, const float color[4])
{
...
static void drawArray(GContext *context, Program *prog)
{
...
void gDrawQuad(GContext *context)
{
